            ...
            pub mod string_pool {
                ...
                unsafe impl _rt::WasmResource for StringPool {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(wasm_import_module = "[export]valkyrie:compiler-types/string-pool")]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_valkyrie_compiler_types_string_pool_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { const _ : () = { #[doc(hidden)] #[export_name =
                        "valkyrie:compiler-types/string-pool#[dtor]string-pool"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                        u8) { $($path_to_types)*:: StringPool::dtor::< <$ty as
                        $($path_to_types)*:: Guest >::StringPool > (rep) } }; const _ :
                        () = { #[doc(hidden)] #[export_name =
                        "valkyrie:compiler-types/string-pool#[dtor]identifier"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                ...
                #[doc(hidden)]
                pub(crate) use __export_valkyrie_compiler_types_string_pool_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod source_pool {
                #[used]
                ...
                unsafe impl _rt::WasmResource for SourcePool {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]valkyrie:compiler-types/source-pool")]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_valkyrie_compiler_types_source_pool_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { const _ : () = { #[doc(hidden)] #[export_name =
                        "valkyrie:compiler-types/source-pool#[dtor]source-pool"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                        u8) { $($path_to_types)*:: SourcePool::dtor::< <$ty as
                        $($path_to_types)*:: Guest >::SourcePool > (rep) } }; const _ :
                        () = { #[doc(hidden)] #[export_name =
                        "valkyrie:compiler-types/source-pool#[dtor]source-id"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                ...
                #[doc(hidden)]
                pub(crate) use __export_valkyrie_compiler_types_source_pool_cabi;
            }
        }
    }
}
...
macro_rules! __export_types_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::valkyrie::compiler_types::string_pool::__export_valkyrie_compiler_types_string_pool_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::valkyrie::compiler_types::string_pool); $($path_to_types_root)*::
        exports::valkyrie::compiler_types::source_pool::__export_valkyrie_compiler_types_source_pool_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::valkyrie::compiler_types::source_pool);
    };
}
#[doc(inline)]
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x92\x04\x01A\x02\x01\
A\x0c\x01m\x04\x04main\x0astandalone\x04test\x04hide\x03\0\x0enamespace-kind\x03\
\0\0\x01m\x03\x04auto\x0casynchronous\x0bsynchronous\x03\0\x11asynchronous-kind\x03\
\0\x02\x01m\x02\x05macro\x05micro\x03\0\x0dfunction-kind\x03\0\x04\x01B\x06\x01m\
\x04\x04main\x0astandalone\x04test\x04hide\x04\0\x0enamespace-kind\x03\0\0\x01m\x03\
\x04auto\x0casynchronous\x0bsynchronous\x04\0\x11asynchronous-kind\x03\0\x02\x01\
m\x02\x05macro\x05micro\x04\0\x0dfunction-kind\x03\0\x04\x03\0\x1bvalkyrie:compi\
ler-types/ast\x05\x06\x01B\x02\x04\0\x0bstring-pool\x03\x01\x04\0\x0aidentifier\x03\
\x01\x04\0#valkyrie:compiler-types/string-pool\x05\x07\x01B\x05\x04\0\x0bsource-\
pool\x03\x01\x04\0\x09source-id\x03\x01\x01i\x01\x01r\x03\x04file\x02\x05starty\x03\
endy\x04\0\x0bsource-span\x03\0\x03\x04\0#valkyrie:compiler-types/source-pool\x05\
\x08\x04\0\x12valkyrie:ast/types\x04\0\x0b\x0b\x01\0\x05types\x03\0\0\0G\x09prod\
