...
impl ::core::fmt::Debug for EncodeConfig {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("EncodeConfig").field("generate-dwarf", &self.generate_dwarf).finish()
    }
}
#[repr(C)]
#[derive(Clone, Copy)]
...
impl ::core::fmt::Debug for PolyfillConfig {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("PolyfillConfig").field("name", &self.name).field("shim", &self.shim).finish()
    }
}
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_wat_encode_cabi<T: Guest>(arg0: *mut u8, arg1: usize, arg2: i32) -> *mut u8 {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::wat_encode(_rt::string_lift(bytes0), EncodeConfig { generate_dwarf: _rt::bool_lift(arg2 as u8) });
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_wasm_decode_cabi<T: Guest>(arg0: *mut u8, arg1: usize, arg2: i32, arg3: i32, arg4: i32) -> *mut u8 {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    let len0 = arg1;
...
pub unsafe fn _export_wasi_polyfill_cabi<T: Guest>(
    ...
    let result9 = T::wasi_polyfill(
        _rt::Vec::from_raw_parts(arg0.cast(), len0, len0),
        PolyfillConfig { name: _rt::string_lift(bytes1), shim: result8 },
    );
...
pub trait Guest {
    fn wat_encode(input: _rt::String, config: EncodeConfig) -> Result<_rt::Vec<u8>, ToolsError>;
    fn wasm_decode(input: _rt::Vec<u8>, config: DecodeConfig) -> Result<_rt::String, ToolsError>;
    fn wasi_polyfill(input: _rt::Vec<u8>, config: PolyfillConfig) -> Result<_rt::Vec<(_rt::String, _rt::Vec<u8>)>, ToolsError>;
}
#[doc(hidden)]
