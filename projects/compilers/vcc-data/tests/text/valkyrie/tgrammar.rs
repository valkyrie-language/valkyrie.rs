use vcc_data::text::valkyrie::tgrammar::{TgNode, TgTextPart, parse_tgrammar_fragment, parse_tgrammar_template};
...
fn valkyrie_parser_recognizes_t_string_as_template_expression() {
    use vcc_data::text::valkyrie::{AstParser, RootStatement, TermExpression};
