...
use vcc_data::binary::wasm::{DecodedOperand, WasmByteReader, decode_code_body, decode_instruction, write_sleb128_i64};
...
fn decode_one(bytes: &[u8]) -> vcc_data::binary::wasm::DecodedInstruction {
