...
This optional platform package contains the `vcc.linux-x64-musl.node` N-API addon built from `projects/compilers/vcc-napi`. It is pulled in
...
| File             | Description                   |
|------------------|-------------------------------|
| `vcc.linux-x64-musl.node` | Node-API native host (platform-named `.node`) |
